      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        <div className="order-2 lg:order-1">
          ...
          <div className="flex items-center group cursor-pointer w-fit">
            <div className="bg-neutral-900 px-8 py-4 rounded-l-2xl transition-colors group-hover:bg-neutral-800">
              <span className="text-white font-bold text-lg">Get Started</span>
            </div>
            <div className="bg-neutral-800 px-6 py-4 rounded-r-2xl transition-colors group-hover:bg-neutral-700">
